...
ComplexNumber.prototype = {
	 ...
	 * @return String
	 	...
	 	I'm changing this to round to 1 decimal place - PL
	 	Also to properly display numbers with negative imaginary parts - PL 

	 */
	toString: function() {

		if(this.imaginary < 0)
			return Math.floor(this.real*10)/10 + " - " +
				Math.floor(this.imaginary*(-10))/10 + "i";
	    else return Math.floor(this.real*10)/10 + " + " + 
	    	Math.floor(this.imaginary*10)/10 + "i";
	}
};